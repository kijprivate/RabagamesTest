...
public class PinchZoom : MonoBehaviour
{
	...
	public float maxZoomFactor = 2;

	void Start() {
		mainCamera = Camera.main;
		maxOrtho = mainCamera.orthographicSize;
	}
	...
	void Update()
	{
		...
		if (Input.touchCount == 2)
		{
			...
			if (mainCamera.orthographic)
			{
				...
				mainCamera.orthographicSize = Mathf.Min(Mathf.Max(mainCamera.orthographicSize, maxOrtho / maxZoomFactor), maxOrtho);
			}
			else
			{
